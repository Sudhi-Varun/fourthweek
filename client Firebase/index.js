...
import { doc, setDoc, updateDoc, deleteDoc, getDocs, getDoc, query, orderBy} from "firebase/firestore"; 
...
{
     var querySnapshot = await getDocs(query(collection(fbhandle, "varundb3"),orderBy('updatedAt')));
